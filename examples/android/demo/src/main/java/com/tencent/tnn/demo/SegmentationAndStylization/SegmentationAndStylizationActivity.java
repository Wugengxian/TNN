...
public class SegmentationAndStylizationActivity extends DemoBaseActivity {
    private static final String TAG = SegmentationAndStylizationActivity.class.getSimpleName();
    ...
    public void updateUI() {
        Fragment fragment = new SegmentationAndStylizationFragment();
